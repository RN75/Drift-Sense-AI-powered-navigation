"""
test_gradient_order_s2.py
Test Sample 2 with proper gradient order.
"""
...
def test():
    ref = cv2.imread("test_data/reference/sample_0002_ref.png", cv2.IMREAD_GRAYSCALE)
    search = cv2.imread("test_data/search/sample_0002_search.png", cv2.IMREAD_GRAYSCALE)
    gt_x, gt_y = 517.1, 262.2
